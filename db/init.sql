...
('Téléphone', 'images/telephone.jpg', 15, ST_SetSRID(ST_MakePoint(2.588558, 48.840379), 4326)),
('Casquette', 'images/casquette.jpg', 15, ST_SetSRID(ST_MakePoint(2.589121,48.848699), 4326)),
('Marinière', 'images/mariniere.jpg', 15, ST_SetSRID(ST_MakePoint(2.580884, 48.836886), 4326)),
('Portefeuille', 'images/portefeuille.jpg', 15, ST_SetSRID(ST_MakePoint(2.59038, 48.833976), 4326)),
('Sac à main', 'images/sac.jpg', 15, ST_SetSRID(ST_MakePoint(2.585031, 48.846772), 4326)),
('Bouteille de Jaeger', 'images/jaeger.jpg', 15, ST_SetSRID(ST_MakePoint(2.583864379,48.8459606), 4326)),
('Bouteille de Jaeger', 'images/jaeger.jpg', 15, ST_SetSRID(ST_MakePoint(2.580235745,48.8482698), 4326)),
('Bouteille de Jaeger', 'images/jaeger.jpg', 15, ST_SetSRID(ST_MakePoint(2.590833511,48.8370957), 4326)),
('Louise Vadeaudeau', 'images/Louise.jpg', 15, ST_SetSRID(ST_MakePoint(2.591552466454641, 48.843020341145845), 4326));
